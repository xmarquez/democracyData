...
with 41979 rows and 20 columns.
...
it with the latest democracy datasets included in `democracyData`
through 2025, and calculating scores for countries not in the official
UD release. Cite both Pemstein, Meserve, and Melton 2010 as well as
Marquez 2016.
...
generating democracy scores for 41979 country-years (299 distinct
...
(the `vaporeg_trichotomous` indicator),
...
(the `wth_democrobust` variable). Please refer to the documentation of
